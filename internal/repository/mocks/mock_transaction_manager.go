...
// Source: github.com/vekshinnikita/pulse_watch/internal/repository (interfaces: TransactionManager)
//
// Generated by this command:
//
//	mockgen -destination=mocks/mock_transaction_manager.go -package=mock_repository . TransactionManager
//
